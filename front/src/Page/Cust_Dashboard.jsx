...
function Cust_Dashboard({ isAuth, logout, setIsAuth }) {
  ...
  async function getCustomer() {
    try {
      ...
      let resp = await axios.get(`/api/customer/${id}`, {
        headers: {
  ...
  async function getCustomerApp() {
    try {
      let token = localStorage.getItem("token");
      let resp = await axios.get(`/api/customer/${id}/app`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  async function addVehicle() {
    try {
      let token = localStorage.getItem("token");
      await axios.post(`/api/customer/newvehicle/${id}`, addVehicles, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  async function addAppointment() {
    try {
      ...
      let token = localStorage.getItem("token");
      let resp = await axios.post(`/api/appointment/new/${id}`, appoint, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
